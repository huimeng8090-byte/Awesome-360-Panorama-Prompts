...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/提示词-469+-8250df?style=flat-square">
  <img src="https://img.shields.io/badge/分类-16-f778ba?style=flat-square">
</p>

本仓库收录 **469+** 条 360° 全景图提示词，每条包含完整的结构化 JSON，可直接用于 GPT Image 等模型生成无缝拼接的等距柱状投影（Equirectangular）全景图。
...
|  |  |  |
|---|---|---|
| <img src="images/case481/output.jpg" height="200" style="object-fit:cover;border-radius:6px;"> | <img src="images/case480/output.jpg" height="200" style="object-fit:cover;border-radius:6px;"> | <img src="images/case479/output.jpg" height="200" style="object-fit:cover;border-radius:6px;"> |
| <img src="images/case478/output.jpg" height="200" style="object-fit:cover;border-radius:6px;"> | <img src="images/case477/output.jpg" height="200" style="object-fit:cover;border-radius:6px;"> | <img src="images/case476/output.jpg" height="200" style="object-fit:cover;border-radius:6px;"> |

<p align="center"><a href="https://huimeng8090-byte.github.io/Awesome-360-Panorama-Prompts/" target="_blank">→ 查看全部 469 条</a></p>
...
<a href="https://huimeng8090-byte.github.io/Awesome-360-Panorama-Prompts/?category=%E6%99%AF%E5%8C%BA" target="_blank"><img src="https://img.shields.io/badge/景区-84-8250df?style=flat-square"></a>
